...
//        rlTitle.setBackgroundColor(mTManager.colorTitleBG());
        rlTitle.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape2));
        ...
        LinearLayout.LayoutParams ll1= new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        ll1.setMargins(0, 0, MeasureUtil.dp2px(getContext(), 10), 0);
        tvYear.setLayoutParams(ll1);
